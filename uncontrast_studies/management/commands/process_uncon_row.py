...
from uncontrast_studies.parsers.sample_parser import resolve_uncon_samples
...
def process_uncon_row(item: dict):
    ...
    for consciousness_measure in consciousness_measures_data:
        ...
        if consciousness_measure.sub_type:
            sub_type, created = UnConsciousnessMeasureSubType.objects.get_or_create(name=consciousness_measure.sub_type,
                                                                                    type=main_type)
        else:
            sub_type = None
        UnConsciousnessMeasure.objects.create(experiment=experiment, phase=phase, type=main_type, sub_type=sub_type,
