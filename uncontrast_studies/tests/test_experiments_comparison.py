...
class TestExperimentsComparisonGraphTestCase(UnContrastBaseTestCase):
    ...
    def test_sanity_implementation(self):
        ...
        for breakdown in UNCONTRAST_GRAPH_BREAKDOWN_OPTIONS:
            target_url = self.reverse_with_query_params(
                "uncontrast-experiments-graphs-parameters-distribution-experiments-comparison", breakdown=breakdown
            )
