...
def add_missing_sub_stimulus_category_other(apps, schema_editor):
    ...
    stimuli_to_process = Stimulus.objects.filter(category__in=categories_with_sub_categories).filter(
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(add_missing_sub_stimulus_category_other, reverse_code=migrations.RunPython.noop)]
