...
class AcrossTheYearsGraphTestCase(BaseTestCase):
    ...
    def test_across_the_years_breakdown_paradigm_family(self):
        ...
        target_url = self.reverse_with_query_params("experiments-graphs-across-the-years", breakdown="paradigm_family")
    ...
    def test_across_the_years_breakdown_paradigm(self):
        ...
        target_url = self.reverse_with_query_params("experiments-graphs-across-the-years", breakdown="paradigm")
        res = self.client.get(target_url)
        self.assertEqual(res.status_code, status.HTTP_200_OK)
    ...
    def test_across_the_years_breakdown_measures(self):
        ...
        target_url = self.reverse_with_query_params("experiments-graphs-across-the-years", breakdown="measure")
        res = self.client.get(target_url)
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertEqual(len(res.data), 3)
        first_series = res.data[0]
    ...
    def test_across_the_years_techniques_breakdown(self):
        ...
        target_url = self.reverse_with_query_params("experiments-graphs-across-the-years", breakdown="technique")
        res = self.client.get(target_url)
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertEqual(len(res.data), 2)
        first_series = res.data[0]
    ...
    def test_across_the_years_is_reporting_breakdown(self):
        ...
        target_url = self.reverse_with_query_params("experiments-graphs-across-the-years", breakdown="reporting")
        res = self.client.get(target_url)
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertEqual(len(res.data), 2)
        first_series = res.data[0]
