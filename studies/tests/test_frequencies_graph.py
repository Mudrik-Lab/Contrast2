...
class FrequenciesGraphTestCase(BaseTestCase):
    ...
    def _given_world_setup(self):
        ...
        self.gnw_parent_theory = self.given_theory_exists(parent=None, name="GNW_parent")
        self.rpt_parent_theory = self.given_theory_exists(parent=None, name="RPT_parent")
