...
from studies.views.submitted_studies_experiments_related_objects import (
    StudyExperimentsTasks,
    StudyExperimentsSamples,
    StudyExperimentsStimuli,
    StudyExperimentsMeasures,
    StudyExperimentsInterpretations,
    StudyExperimentsFindingTags,
...
studies_experiments_nested_router.register(
    "interpretations", StudyExperimentsInterpretations, basename="interpretations"
)
