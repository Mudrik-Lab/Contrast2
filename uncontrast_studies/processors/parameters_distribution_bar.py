...
from uncontrast_studies.models import UnConMainParadigm
...
class ParametersDistributionBarGraphDataProcessor(BaseProcessor):
    ...
    def process_paradigm(self):
        experiments_subquery_by_breakdown = self.experiments.filter(paradigms__main=OuterRef("pk")).values(
            "experiment", "relation_type"
        )
