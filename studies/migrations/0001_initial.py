...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('healthy_adults', 'Healthy_adults'), ('children', 'Children'), ('patients', 'Patients'), ('non_human', 'Non_human'), ('computer', 'Computer')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='measures', to='studies.measuretype')),
            ],
        ),
        migrations.CreateModel(
            name='Interpretation',
            fields=[
                ...
                ('experiment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='theories', to='studies.experiment')),
                ('theory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='experiments', to='studies.theory')),
            ],
        ),
        migrations.CreateModel(
            name='FindingTag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField(blank=True, null=True)),
                ('experiment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consciousness_measures', to='studies.experiment')),
                ('phase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studies.consciousnessmeasurephasetype')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studies.consciousnessmeasuretype')),
            ],
        ),
    ]
