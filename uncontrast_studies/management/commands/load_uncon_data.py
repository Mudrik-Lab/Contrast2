...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        historic_data_list = get_list_from_excel("uncontrast_studies/data/UnContrast_Existing_Data.xlsx", sheet_name="sheet1")
        studies_historic_data_list = get_list_from_excel(
            "uncontrast_studies/data/UnContrast_Existing_Data.xlsx", sheet_name="Included_Metadata"
        )
