...
class UnContrastBaseTestCase(BaseTestCase):
    ...
    def given_uncon_processing_sub_domain_exists(self, name: str):
        params = dict(
            name=name,
        )
        processing_sub_domain, created = UnConProcessingSubDomain.objects.get_or_create(**params)
        return processing_sub_domain
